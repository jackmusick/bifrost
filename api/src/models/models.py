...
This file consolidates both the original API models and CRUD pattern models.
Uses inheritance to minimize field duplication for CRUD patterns.
"""
...
# Import enums from canonical location
from src.models.enums import ExecutionStatus, ConfigType, FormFieldType, FormAccessLevel, UserType
...
# ==================== UNIFIED SDK MODELS ====================
# These models are shared between internal (workflow) and external (API) SDK modes

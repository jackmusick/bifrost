...
export interface paths {
	...
	"/api/workflows/execute": {
		 ...
		 * @description Execute a workflow by ID. Requires platform admin, API key, or access via form/app.
		 */
...
export interface components {
	schemas: {
		...
		/**
		 * ApplicationExport
		 * @description Full application export for GitHub sync/portability.
		 */
		ApplicationExport: {
			/** Name */
			name: string;
		...
		DataProviderMetadata: {
			...
			description?: string | null;
			/**
			 * @description Always 'data_provider' for this model
			...
			/**
			 * Timeout Seconds
			 * @description Max execution time in seconds (default 5 min)
			 * @default 300
			 */
...
export interface operations {
	...
	mfa_initial_setup_auth_mfa_setup_post: {
		...
		requestBody?: {
			content: {
				"application/json":
					| components["schemas"]["MFASetupRequest"]
					| null;
			};
		};
		responses: {
	...
	exchange_device_token_auth_device_token_post: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["DeviceTokenResponse"]
						| components["schemas"]["DeviceTokenErrorResponse"];
				};
			};
			/** @description Validation Error */
			422: {
	...
	sdk_integrations_get_api_cli_integrations_get_post: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["SDKIntegrationsGetResponse"]
						| null;
				};
			};
			/** @description Validation Error */
	...
	sdk_integrations_list_mappings_api_cli_integrations_list_mappings_post: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["SDKIntegrationsListMappingsResponse"]
						| null;
				};
			};
			/** @description Validation Error */
	...
	sdk_integrations_get_mapping_api_cli_integrations_get_mapping_post: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["SDKIntegrationsMappingItem"]
						| null;
				};
			};
			/** @description Validation Error */
	...
	cli_knowledge_get_api_cli_knowledge_get_get: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["CLIKnowledgeDocumentResponse"]
						| null;
				};
			};
			/** @description Validation Error */
	...
	cli_get_document_api_cli_tables_documents_get_post: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["SDKDocumentData"]
						| null;
				};
			};
			/** @description Validation Error */
	...
	get_email_config_api_admin_email_config_get: {
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json":
						| components["schemas"]["EmailWorkflowConfigResponse"]
						| null;
				};
			};
		};
	...
	test_oauth_config_api_settings_oauth__provider__test_post: {
		...
		requestBody?: {
			content: {
				"application/json":
					| components["schemas"]["OAuthConfigTestRequest"]
					| null;
			};
		};
		responses: {
	...
	retry_delivery_api_events_deliveries__delivery_id__retry_post: {
		...
		requestBody?: {
			content: {
				"application/json":
					| components["schemas"]["RetryDeliveryRequest"]
					| null;
			};
		};
		responses: {
	...
	export_application_api_applications__app_id__export_get: {
		parameters: {
			query?: {
				/** @description Export draft or live version */
				is_draft?: boolean;
				scope?: string | null;
			};
			header?: never;
		...
		responses: {
			...
			200: {
				...
				content: {
					"application/json": components["schemas"]["ApplicationExport"];
				};
			};
			/** @description Validation Error */
			422: {
	...
	list_pages_api_applications__app_id__pages_get: {
		parameters: {
			query?: {
				/** @description Get draft or live pages */
				is_draft?: boolean;
			};
			header?: never;
			path: {
	...
	get_page_api_applications__app_id__pages__page_id__get: {
		parameters: {
			query?: {
				/** @description Get draft or live version */
				is_draft?: boolean;
			};
			header?: never;
			path: {
	...
	list_components_api_applications__app_id__pages__page_id__components_get: {
		parameters: {
			query?: {
				/** @description Get draft or live components */
				is_draft?: boolean;
			};
			header?: never;
			path: {
	...
	get_component_api_applications__app_id__pages__page_id__components__component_id__get: {
		parameters: {
			query?: {
				/** @description Get draft or live component */
				is_draft?: boolean;
			};
			header?: never;
			path: {

...
export interface components {
    schemas: {
        ...
        DataProviderInputConfig: {
            ...
            /**
             * Value
             * @description Fixed value to pass (required when mode='static')
             */
            value?: string | null;
            /**
             * Field Name
             * @description Name of another form field to get value from (required when mode='fieldRef')
             */
            field_name?: string | null;
            /**
             * Expression
             * @description JavaScript expression like 'context.field.org_id' (required when mode='expression')
             */
        ...
        UpdateOAuthConnectionRequest: {
             ...
             * @description OAuth 2.0 flow type
             */
            oauth_flow_type?: ("authorization_code" | "client_credentials" | "refresh_token") | null;
            /** Client Id */
            client_id?: string | null;
            /** Client Secret */
            client_secret?: string | null;
...
export interface operations {
    ...
    write_app_file_api_applications__app_id__files__file_path__put: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AppFileUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
